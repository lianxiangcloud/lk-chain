...
func (info NodeInfo) String() string {
	return fmt.Sprintf("NodeInfo{pk: %v, moniker: %v, type: %v, network: %v, listen: %v, addrs: %v, version: %v (%v)}", info.PubKey, info.Moniker, info.Type, info.Network, info.ListenAddr, info.LocalAddrs, info.Version, info.Other)
}
