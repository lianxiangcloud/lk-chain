...
type BaseConfig struct {
	...
	// start block num
	BlockStartNum int64 `mapstructure:"block_num"`

	// Node type enum{ validator, peer, listener }
	NodeType string `mapstructure:"node_type"`

	// boss svr verify code
	VerifyCode string `mapstructure:"verify_code"`

	// ethermint rpc addr
	EthRpcAddr string `mapstructure:"eth_rpcaddr"`

	//update timer seconds
	Interval int `mapstructure:"interval"`

	// rollback block number
	RollbackBlockNumber int64 `mapstructure:"rollbackblocknumber"`
}
...
type P2PConfig struct {
	...
	// BootNode Server URL
	BootNodeURL string `mapstructure:"bootnodeurl"`
}
...
func DefaultP2PConfig() *P2PConfig {
	return &P2PConfig{
		...
		MaxMsgPacketPayloadSize: 64 * 1024, // 64 KB
		SendRate:                5120000,   // 5 MB/s
		RecvRate:                5120000,   // 5 MB/s
		PexReactor:              true,
		BootNodeURL:             "https://peer.lianxiangcloud.com/getpeers",
	}
}
...
type MempoolConfig struct {
	...
	RateTooManyTxs float64 `mapstructure:"rate_too_many_txs"`
}
...
//DebugConfig define the configuration for debugging
type DebugConfig struct {
	...
	//open net/http/pprof & pprofport && pprofaddr
	Pprof     bool   `mapstructure:"pprof"`
	Pprofport int    `mapstructure:"pprofport"`
	Pprofaddr string `mapstructure:"pprofaddr"`
}

// DefaultDebugConfig returns a default configuration for the debug related stuffs.
