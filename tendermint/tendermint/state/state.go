...
LastValidators:
%v
LastHeightValidatorsChanged: 		%d
ConsensusParams:
%s
LastHeightConsensusParamsChanged:	%d
LastResultsHash:			0x%x
AppHash:				0x%x
Coinbase: 				%s
`, 		s.ChainID,
		s.LastBlockHeight,
		...
		s.Validators,
		s.LastValidators,
		s.LastHeightValidatorsChanged,
		s.ConsensusParams,
		s.LastHeightConsensusParamsChanged,
		s.LastResultsHash,
		s.AppHash,
		s.Coinbase,
	)
...
func (s State) MakeBlock(coinbase string, height int64, txs []types.Tx, commit *types.Commit) (*types.Block, *types.PartSet) {
	// build base block
...
func MakeGenesisState(genDoc *types.GenesisDoc) (State, error) {
	...
	return State{
		...
		LastBlockHeight:             genDoc.BlockStartNum,
		LastBlockID:                 types.BlockID{},
		LastBlockTime:               genDoc.GenesisTime,
		Validators:                  types.NewValidatorSet(validators),
		LastValidators:              types.NewValidatorSet(nil),
		LastHeightValidatorsChanged: genDoc.BlockStartNum + 1,

		ConsensusParams:                  *genDoc.ConsensusParams,
		LastHeightConsensusParamsChanged: 1,

		AppHash:  genDoc.AppHash,
		Coinbase: genDoc.Coinbase,
	}, nil
}
